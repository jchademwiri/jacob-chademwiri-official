      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              We create beautiful, functional, and accessible web experiences with modern technologies and a focus on
              sustainability.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© {currentYear} GreenDesign. All rights reserved.</p>
            <p className="text-sm text-muted-foreground mt-4 sm:mt-0">Designed & Built with sustainability in mind</p>
          </div>
        </div>
      </div>
    </footer>
